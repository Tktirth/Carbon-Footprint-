...
Only the latest version of EcoTrack is supported with security updates.
...
2. **Details to Include**:
   - The steps required to reproduce the vulnerability (including proof-of-concept scripts or API payloads where applicable).
